...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dist/game.bundle.js":[function(require,module,exports) {
var define;
...
function (module, exports, __webpack_require__) {
  ...
  var Player = exports.Player = function (_Phaser$Sprite) {
    ...
    function Player(game) {
      ...
      _this.anchor.setTo(0.5); //  Input Enable the sprite


      _this.inputEnabled = true; //  Allow dragging - the 'true' parameter will make the sprite snap to the center
...
function (module, exports, __webpack_require__) {
  ...
  var Bowser = exports.Bowser = function (_GenericEnemy) {
    ...
    function Bowser(game, x, y, key, health, weapon) {
      _classCallCheck(this, Bowser); // positioning
      ...
      _this.anchor.setTo(0.5, 1); // initialize animations
    ...
    _createClass(Bowser, [{
      ...
      value: function reset(x, y, health, key, scale, speedX, speedY) {
        ...
        this.scale.setTo(scale / 3); // resume timer
...
function (module, exports, __webpack_require__) {
  ...
  var GenericEnemy = exports.GenericEnemy = function (_Phaser$Sprite) {
    ...
    function GenericEnemy(game, x, y, key, health, weapon, frame) {
      _classCallCheck(this, GenericEnemy); // set variables
      ...
      _this.health = health; // create and initiate timer

      _this.enemyTimer = _this.game.time.create(false); // keeps timer alive after it's done

      _this.enemyTimer.start(); // positioning


      _this.anchor.setTo(0.5); // physics properties
    ...
    _createClass(GenericEnemy, [{
      ...
      value: function damage(amount) {
        ...
        _get(GenericEnemy.prototype.__proto__ || Object.getPrototypeOf(GenericEnemy.prototype), 'damage', this).call(this, amount); // play animation


        this.animateGetHit(); // when dead
      ...
      value: function reset(x, y, health, key, scale, speedX, speedY) {
        ...
        this.body.velocity.x = speedX;
        this.body.velocity.y = speedY;
        this.scale.setTo(scale); // resume timer
...
function (module, exports, __webpack_require__) {
  ...
  var LittleDevil = exports.LittleDevil = function (_Phaser$Sprite) {
    ...
    function LittleDevil(game, x, y) {
      ...
      _classCallCheck(this, LittleDevil); // this.game.add.existing( this );
    ...
    _createClass(LittleDevil, [{
      ...
      value: function scheduleShooting() {
        var bullet = this.weapon.fire(this, this.game.player.x, this.game.player.y);
        if (bullet !== null) bullet.scale.setTo(0.5); // TODO: on bullet kill set scale back to 1
      ...
      value: function damage(amount) {
        // sprite damage functionality
        _get(LittleDevil.prototype.__proto__ || Object.getPrototypeOf(LittleDevil.prototype), 'damage', this).call(this, amount); // play animation
        // this.animateGetHit();
        // when dead
      ...
      value: function update() {
        //  Wave movement
        this.body.x = this.startingX + Math.sin(this.y / this.frequency) * this.spread; //  Squish and rotate ship for illusion of "banking"

        this.bank = Math.cos((this.y + 60) / this.frequency); //   this.scale.x = 0.5 - Math.abs(this.bank) / 8;

        this.scale.x = 1 - Math.abs(this.bank) / 8; //   this.angle = 180 - this.bank * 2;

        this.angle = this.bank * 2; // kill object at bottom
    ...
    _createClass(StateManager, [{
      ...
      value: function setupListeners() {
        ...
        this.game.on(_stateEvents2.default.LOADING_COMPLETED, function () {
          _this.game.state.start('Game'); // this.game.state.start('BowserWithPeachDemo');
...
function (module, exports, __webpack_require__) {
  ...
  var FlirtyGirl = exports.FlirtyGirl = function (_GenericEnemy) {
    ...
    function FlirtyGirl(game, x, y, key, health, weapon) {
      ...
      _this.smoothed = false; // initialize animations
  ...
  var LipsBullet = function (_Phaser$Bullet) {
    ...
    _createClass(LipsBullet, [{
      ...
      value: function reset(x, y) {
        _get(LipsBullet.prototype.__proto__ || Object.getPrototypeOf(LipsBullet.prototype), 'reset', this).call(this, x, y); // this.scale.setTo( scale / 2 );
...
function (module, exports, __webpack_require__) {
  ...
  var PeachCoin = exports.PeachCoin = function (_Phaser$Sprite) {
    ...
    function PeachCoin(game, x, y) {
      ...
      var _this = _possibleConstructorReturn(this, (PeachCoin.__proto__ || Object.getPrototypeOf(PeachCoin)).call(this, game, x, y, key)); // constructor( game, x, y, key = 'princessMushroom', health ) {
      ...
      _this.game.add.existing(_this); // this.scale.setTo( 1.5, 1.5 );
...
function (module, exports, __webpack_require__) {
  ...
  var RedDevil = exports.RedDevil = function (_Phaser$Sprite) {
    ...
    function RedDevil(game, x, y, key, health, weapons) {
      _classCallCheck(this, RedDevil); // set variables
      ...
      _this.animations.add('toot', [14, 15], 4); // physics properties
    ...
    _createClass(RedDevil, [{
      ...
      value: function scheduleShooting() {
        ...
        this.enemyTimer.add(Phaser.Timer.SECOND * 2, function () {
          var _this2 = this; // let flip    = this.play( 'flip' );
      ...
      value: function damage(amount) {
        // sprite damage functionality
        _get(RedDevil.prototype.__proto__ || Object.getPrototypeOf(RedDevil.prototype), 'damage', this).call(this, amount); // play animation
        // this.animateGetHit();
        // when dead
      ...
      value: function reset(x, y, health, key, scale, speedX, speedY) {
        ...
        var descend = this.game.add.tween(this).to({
          x: x,
          y: 150
        }, 2000, "Sine.easeInOut");
  ...
  var BowserWithPeachDemo = exports.BowserWithPeachDemo = function (_Phaser$State) {
    ...
    _createClass(BowserWithPeachDemo, [{
      ...
      value: function init(currentLevel) {
        this.game.physics.startSystem(Phaser.Physics.ARCADE); // level data
      ...
      value: function create() {
        ...
        this.bowser = new _bowser.Bowser(this.game, this.game.world.centerX, this.game.world.centerY, 'bowser', 12, this.bowsers.weapon); // this.bowser.events.onKilled.add(function( foo ) {
        //     console.log( foo );
      ...
      key: 'update',
      value: function update() {
        var _this2 = this; // this.peach.x    = this.bowser.x;
        ...
        this.game.physics.arcade.overlap(this.game.player.weapon.bullets, this.bowser, function (bowser, bullet) {
          bullet.kill();
          bowser.damage(1);
        }, null, this); // enemy bullets & player detection
      ...
      value: function loadLevel() {
        ...
        this.levelData = JSON.parse(this.game.cache.getText('level' + this.currentLevel)); // end of the level timer
      ...
      value: function update() {
        ...
        this.levelData.groups.forEach(function (group) {
          ...
          _this2.game.physics.arcade.overlap(bullets, _this2.game.player, function (player, bullet) {
            ...
            _this2.game.juicy.shake();
          }, null, _this2); // enemies & player bullet overlap detection
  ...
  var LoadingState = exports.LoadingState = function (_Phaser$State) {
    ...
    _createClass(LoadingState, [{
      ...
      value: function preload() {
        ...
        this.load.spritesheet('redDevil', 'assets/images/red-devil.png', 160, 166); //load level data
...
function (module, exports, __webpack_require__) {
  !function (e, t) {
    true ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == _typeof(exports) ? exports.EventEmitter = t() : e.EventEmitter = t();
  }(this, function () {
    return function (e) {
      function t(i) {
      ...
      */
      ...
      function i(e, t) {
        var n = ("forEach" in Array.prototype);
        if (n) e.forEach(t);else for (var i = 0; i < e.length; i += 1) {
          t(e[i]);
        }
      }

      function r(e, t) {
        var n = ("filter" in Array.prototype);
        if (n) return e.filter(t);
      ...
      function c() {
        return this instanceof c ? void (this._listeners = []) : new c();
      }

      var f = n(2),
          u = {
        on: function on(e, t, n) {
          return o(s(e), "EventEmitter#on: name is not a string"), o(a(t), "EventEmitter#on: fn is not a function"), n = n || this, this._listeners.push({
            name: e,
            fn: t,
            ctx: n
          }), this;
        ...
        off: function off(e, t) {
          return this._listeners = e ? r(this._listeners, function (n) {
            return n.name !== e || !!a(t) && n.fn !== t;
          }) : [], this;
        },
        emit: function emit(e, t) {
          return o(s(e), "EventEmitter#emit: name is not a string"), i(this._listeners, function (n) {
            n.name === e && n.fn.call(n.ctx, t);
            var i = /^all|\*$/.test(n.name);
            i && n.fn.call(n.ctx, e, t);
          }), this;
        }
      };
      u.addEventListener = u.addListener = u.bind = u.on, u.removeEventListener = u.removeListener = u.unbind = u.off, u.dispatchEventListener = u.dispatchListener = u.trigger = u.emit, c.prototype = u, c.mixin = function (e) {
        var t = new c();
        ...
        return e;
      }, c.prototype.mixin = c.mixin, c.VERSION = f.version, e.exports = c;
    }, function (e, t) {
      e.exports = {
        name: "super-event-emitter",
        description: "Super small (2KB) and simple interpretation of popular event management.",
        ...
        files: ["dist", "lib", "index.js", "package.json", "README.md"],
        keywords: ["super", "event", "emitter", "mixin", "on", "off", "emit", "trigger", "simple"],
...
function (module, exports, __webpack_require__) {
  ...
  var CoolInvader = exports.CoolInvader = function (_GenericEnemy) {
    ...
    function CoolInvader(game, x, y, key, health, weapon) {
      _classCallCheck(this, CoolInvader); // positioning
...
function (module, exports, __webpack_require__) {
  ...
  var RainbowInvader = exports.RainbowInvader = function (_GenericEnemy) {
    ...
    function RainbowInvader(game, x, y, key, health, weapon) {
      _classCallCheck(this, RainbowInvader); // positioning
...
},{}]},{},["../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js","dist/game.bundle.js"], null)
//# sourceMappingURL=/game.bundle.a6dbbca4.js.map